...
::div{ .grid .grid-cols-3 .items-center .w-full .gap-x-8 }
  ![sky](https://picsum.photos/id/120/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg .col-span-1 }
  ::div{ .col-span-2 }
...
::div{ .grid .grid-cols-3 .items-center .w-full .gap-x-8 }
  ...
  ::
  ![mountain](https://picsum.photos/id/235/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg .col-span-1 }
::

## Embarking into the Unknown

::div{ .grid .grid-cols-3 .items-center .w-full .gap-x-8 }
  ![rocket](https://picsum.photos/id/137/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg .col-span-1 }
  ::div{ .col-span-2 }
...
::div{ .grid .grid-cols-3 .items-center .w-full .gap-x-8 }
  ...
  ::
  ![universe](https://picsum.photos/id/974/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg .col-span-1 }
::

## Legacy of Discovery

::div{ .grid .grid-cols-3 .items-center .w-full .gap-x-8 }
  ![woman](https://picsum.photos/id/550/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg .col-span-1 }
  ::div{ .col-span-2 }
...
::div{ .grid .grid-cols-3 .items-center .w-full .gap-x-8  }
  ...
  ::
  ![sunset](https://picsum.photos/id/967/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg .col-span-1 }
::
