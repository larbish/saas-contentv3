...
![mountains](https://picsum.photos/id/11/1000/600){ crossorigin="anonymous" width="1000" height="600" .rounded-md }
...
::div{ .flex .space-x-4 .items-center .justify-between }
  ::div
    ![rocks](https://picsum.photos/id/15/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg }
  ::
  ::div
    ![valley](https://picsum.photos/id/28/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg }
  ::
  ::div
    ![mountains](https://picsum.photos/id/29/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg }
  ::
::
...
::div{ .flex .flex-col .items-center .justify-between }
  ::div
    ![valley](https://picsum.photos/id/118/1200/400){ crossorigin="anonymous" width="1200" height="400" .rounded-lg .w-full }
  ::
  ::div{ .flex .items-center .justify-between .w-full .space-x-4 }
    ::div
      ![valley](https://picsum.photos/id/121/600/400){ crossorigin="anonymous" width="600" height="400" .rounded-lg }
    ::
    ::div
      ![traveler](https://picsum.photos/id/177/600/400){ crossorigin="anonymous" width="600" height="400" .rounded-lg }
    ::
  ::div
::
...
::div{ .flex .space-x-4 .items-center .justify-between }
  ::div
    ![wood](https://picsum.photos/id/190/200/200){ crossorigin="anonymous" width="200" height="200" .rounded-lg }
  ::
  ::div
    ![cow](https://picsum.photos/id/200/200/200){ crossorigin="anonymous" width="200" height="200" .rounded-lg }
  ::
  ::div
    ![meadow](https://picsum.photos/id/206/200/200){ crossorigin="anonymous" width="200" height="200" .rounded-lg }
  ::
  ::div
    ![birds](https://picsum.photos/id/258/200/200){ crossorigin="anonymous" width="200" height="200" .rounded-lg }
  ::
::
::div{ .flex .space-x-4 .items-center .justify-between }
  ::div
    ![road](https://picsum.photos/id/278/600/300){ crossorigin="anonymous" width="600" height="300" .rounded-lg .w-full }
  ::
  ::div
    ![hole in a rock](https://picsum.photos/id/343/600/300){ crossorigin="anonymous" width="600" height="300" .rounded-lg .w-full }
  ::
::
...
![mountains](https://picsum.photos/id/368/600/300){ crossorigin="anonymous" width="600" height="300" .rounded-lg .w-full }
