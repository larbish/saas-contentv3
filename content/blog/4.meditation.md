...
![grass in wood](https://picsum.photos/id/55/1200/600){ crossorigin="anonymous" width="1200" height="600" .rounded-lg }
...
::div{ .grid .grid-cols-2 .space-x-4 .justify-between .items-center }
  ::div
    ![flowers](https://picsum.photos/id/106/600/200){ crossorigin="anonymous" width="600" height="200" .rounded-lg }
  ::
  ::div
    ![sakura](https://picsum.photos/id/82/600/200){ crossorigin="anonymous" width="600" height="200" .rounded-lg }
  ::
::
...
![water](https://picsum.photos/id/126/1200/300){ crossorigin="anonymous" width="1200" height="300" .rounded-lg }
...
![nenuphar](https://picsum.photos/id/306/1200/600){ crossorigin="anonymous" width="1200" height="600" .rounded-lg }
