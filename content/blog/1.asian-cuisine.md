...
::div{ .flex .space-x-4 .items-center .justify-between }
  ::div
    ![grappes](https://picsum.photos/id/75/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg }
  ::
  ::div
    ![sakura](https://picsum.photos/id/82/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg }
  ::
  ::div
    ![raspberry](https://picsum.photos/id/102/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg }
  ::
::
...
::div{ .flex .space-x-4 .items-center .justify-between }
  ::div
    ![wheat](https://picsum.photos/id/107/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg }
  ::
  ::div
    ![tea](https://picsum.photos/id/225/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg }
  ::
  ::div
    ![nenuphar](https://picsum.photos/id/306/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg }
  ::
  ::div
    ![flowers](https://picsum.photos/id/488/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg }
  ::
  ::div
    ![yuzu](https://picsum.photos/id/326/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg }
  ::
  ::div
    ![strawberry](https://picsum.photos/id/493/400/400){ crossorigin="anonymous" width="400" height="400" .rounded-lg }
  ::
::
...
::div
  ![fish](https://picsum.photos/id/615/1200/400){ crossorigin="anonymous" width="1200" height="400" .rounded-lg }
::
::tabs
  ::div
  ---
...
::div
  ![kitchen boat](https://picsum.photos/id/686/1200/400){ crossorigin="anonymous" width="1200" height="400" .rounded-lg }
::
::tabs
...
::div
  ![bibimbap](https://picsum.photos/id/292/1200/400){ crossorigin="anonymous" width="1200" height="400" .rounded-lg }
::
::tabs
  ::div{ .flex .space-between .w-full .items-center }
  ---
...
### Cheese Naan (India 🇮🇳)
::div
  ![Naan](https://picsum.photos/id/999/1200/400){ crossorigin="anonymous" width="1200" height="400" .rounded-lg }
::
::tabs
  ::div
  ---
