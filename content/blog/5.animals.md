...
::card{ .not-prose }
  ::div{ .flex .space-x-8 .items-center }
    ::div{ .w-[55%] }
      ![Lion](https://picsum.photos/id/1074/800/400){ crossorigin="anonymous" width="800" height="400" .rounded-lg }
    ::
...
::card{ .not-prose }
  ::div{ .flex .space-x-8 .items-center }
    ::div{ .w-[55%] }
      ![monkey](https://picsum.photos/id/783/800/400){ crossorigin="anonymous" width="800" height="400" .rounded-lg }
    ::
...
::card{ .not-prose }
  ::div{ .flex .space-x-8 .items-center }
    ::div{ .w-[55%] }
      ![wolf](https://picsum.photos/id/582/800/400){ crossorigin="anonymous" width="800" height="400" .rounded-lg }
    ::
...
::card{ .not-prose }
  ::div{ .flex .space-x-8 .items-center }
    ::div{ .w-[55%] }
      ![Bears](https://picsum.photos/id/1020/800/400){ crossorigin="anonymous" width="800" height="400" .rounded-lg }
    ::
...
::card{ .not-prose }
  ::div{ .flex .space-x-8 .items-center }
    ::div{ .w-[55%] }
      ![sea](https://picsum.photos/id/124/800/400){ crossorigin="anonymous" width="800" height="400" .rounded-lg }
    ::
...
::card{ .not-prose }
  ::div{ .flex .space-x-8 .items-center }
    ::div{ .w-[55%] }
      ![human](https://picsum.photos/id/996/800/400){ crossorigin="anonymous" width="800" height="400" .rounded-lg }
    ::
...
::card{ .not-prose }
  ::div{ .flex .space-x-8 .items-center }
    ::div{ .w-[55%] }
      ![marsh](https://picsum.photos/id/128/800/400){ crossorigin="anonymous" width="800" height="400" .rounded-lg }
    ::
...
::card{ .not-prose }
  ::div{ .flex .space-x-8 .items-center }
    ::div{ .w-[55%] }
      ![desert](https://picsum.photos/id/196/800/400){ crossorigin="anonymous" width="800" height="400" .rounded-lg }
    ::
...
::card{ .not-prose }
  ::div{ .flex .space-x-8 .items-center }
    ::div{ .w-[55%] }
      ![Jaguars](https://picsum.photos/id/219/800/400){ crossorigin="anonymous" width="800" height="400" .rounded-lg }
    ::
...
::card{ .not-prose }
  ::div{ .flex .space-x-8 .items-center }
    ::div{ .w-[55%] }
      ![humans](https://picsum.photos/id/978/800/800){ crossorigin="anonymous" width="800" height="800" .rounded-lg }
    ::
